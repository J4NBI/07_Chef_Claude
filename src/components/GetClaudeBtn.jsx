  ...
  return (
    <>
      {props.ingredients.length > 3 && (
        <div className="gap-8 my-12 border-2 border-[#ffd769] p-8 rounded-md flex flex-col md:flex-row justify-between items-center md:w-[90%] bg-white bg-opacity-45 mx-auto">
          <div>
