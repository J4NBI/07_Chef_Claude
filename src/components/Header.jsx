...
const Header = () => {
  return (
  <header className='flex justify-center items-center gap-8 md:w-[900px] p-4 bg-white rounded-t-xl shadow-[0_4px_6px_-1px_rgb(0,0,0,0.1),0_2px_4px_-2px_rgb(0,0,0,0.1)]'>
